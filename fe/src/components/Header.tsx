      ...
      <div className="max-w-4xl mx-auto flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          ...
          {user ? (
            <>
              ...
              >
                ...
                {user.plan !== 'pro' && user.role !== 'admin' && (
                  <span className="text-[9px] bg-amber-400 text-slate-950 px-1 rounded font-bold hidden sm:inline">Upgrade</span>
                )}
              </button>
              ...
              >
                ...
                <span className="hidden sm:inline-block max-w-[100px] truncate">{user.full_name || 'Profile'}</span>
              </button>
            ...
            <button
              onClick={onOpenAuth}
              className="bg-emerald-500 hover:bg-emerald-400 text-slate-950 px-3 py-1.5 sm:px-4 rounded-xl font-bold text-xs shadow-md shadow-emerald-500/20 transition-all shrink-0"
            >
              Sign In
            </button>
          )}
