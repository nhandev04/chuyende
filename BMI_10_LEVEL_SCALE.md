...
- **Cấp 1 - 3**: สี Vàng lá / Vàng chanh (`bg-amber-400`) - *Thiếu cân*
- **Cấp 4 - 5**: Màu Xanh lục lá (`bg-emerald-400`) - *Khỏe mạnh / Lý tưởng*
- **Cấp 6 - 7**: Màu Cam (`bg-orange-400`) - *Tiền thừa cân / Thừa cân*
- **Cấp 8 - 10**: Màu Đỏ sẫm (`bg-rose-500`) - *Béo phì / Cảnh báo nguy cơ*

---

*Hệ thống được phát triển và tối ưu bởi đội ngũ HealthLens AI.*
